...
#include <utility>
#include "br2_fsm_bumpgo_cpp/DistRobotWaypointsNode.hpp"
  ...
  state_(FORWARD)
{
  scan_sub_ = create_subscription<sensor_msgs::msg::LaserScan>(
    ...
    std::bind(&DistRobotWaypointsNode::scan_callback, this, _1));

  vel_pub_ = create_publisher<geometry_msgs::msg::Twist>("output_vel", 10);
  timer_ = create_wall_timer(50ms, std::bind(&DistRobotWaypointsNode::control_cycle, this));

  state_ts_ = now();
}

void
DistRobotWaypointsNode::scan_callback(sensor_msgs::msg::LaserScan::UniquePtr msg)
{
  last_scan_ = std::move(msg);
}

void
DistRobotWaypointsNode::control_cycle()
{
...
bool
DistRobotWaypointsNode::check_forward_2_back()
{
...
bool
DistRobotWaypointsNode::check_forward_2_stop()
{
...
bool
DistRobotWaypointsNode::check_stop_2_forward()
{
...
bool
DistRobotWaypointsNode::check_back_2_turn()
{
...
bool
DistRobotWaypointsNode::check_turn_2_forward()
{
