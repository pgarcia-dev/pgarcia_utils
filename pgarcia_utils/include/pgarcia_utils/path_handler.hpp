...
#ifndef PGARCIA_UTILS__PATH_HANDLER_HPP_
#define PGARCIA_UTILS__PATH_HANDLER_HPP_
...
namespace pgarcia_utils
{

/**
 * @class pgarcia_utils::PathHandler
...
public:
  /**
   * @brief Constructor for pgarcia_utils::PathHandler
   */
  PathHandler(
  ...
  /**
   * @brief Destrructor for pgarcia_utils::PathHandler
   */
  ~PathHandler() = default;
...
#endif  // PGARCIA_UTILS__PATH_HANDLER_HPP_
